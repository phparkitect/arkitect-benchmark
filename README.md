...
_Run: 2026-08-31T03:47:57Z — Symfony v7.2.0 — PHP 8.3.33 — 5 runs per version_

|  | main | 1.3.0 | 1.2.0 | 1.1.1 | 1.1.0 | 1.0.0 |
|---|---|---|---|---|---|---|
| **Median** | 33.2s | 27.1s | 26.4s | 27.0s | 28.4s | 29.3s |
| **vs 1.3.0** | +23% | baseline | ≈ | ≈ | +5% | +8% |
...
_Run: 2026-08-31T03:47:57Z — Akeneo v2026.3 — PHP 8.3.33 — 5 runs per tool — one shared rule_

| Tool | Version | Cold | Warm cache |
|------|---------|------|------------|
| phparkitect | 1.3.0 | 8.0s | — *(no cache)* |
| deptrac | 4.7.1 | 10.7s | 2.9s |
| phpat | 0.11.10 | 45.0s | 2.6s |
