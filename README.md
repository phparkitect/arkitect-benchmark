...
_Run: 2026-09-02T02:59:51Z — Symfony v7.2.0 — PHP 8.3.33 — 5 runs per version_

|  | main | 1.3.0 | 1.2.0 | 1.1.1 | 1.1.0 | 1.0.0 |
|---|---|---|---|---|---|---|
| **Median** | 28.4s | 27.0s | 26.6s | 30.0s | 28.8s | 28.1s |
| **vs 1.3.0** | +5% | baseline | ≈ | +11% | +7% | +4% |
...
_Run: 2026-09-02T02:59:51Z — Akeneo v2026.3 — PHP 8.3.33 — 5 runs per tool — one shared rule_

| Tool | Version | Cold | Warm cache |
|------|---------|------|------------|
| phparkitect | 1.3.0 | 7.4s | — *(no cache)* |
| deptrac | 4.7.1 | 9.4s | 2.5s |
| phpat | 0.11.10 | 41.3s | 2.6s |
