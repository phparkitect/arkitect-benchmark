...
_Run: 2026-09-16T03:26:56Z — Symfony v7.2.0 — PHP 8.3.33 — 5 runs per version_

|  | main | 1.3.0 | 1.2.0 | 1.1.1 | 1.1.0 | 1.0.0 |
|---|---|---|---|---|---|---|
| **Median** | 27.3s | 31.3s | 29.6s | 35.5s | 32.2s | 27.5s |
| **vs 1.3.0** | -13% | baseline | -5% | +13% | ≈ | -12% |
...
_Run: 2026-09-16T03:26:56Z — Akeneo v2026.3 — PHP 8.3.33 — 5 runs per tool — one shared rule_

| Tool | Version | Cold | Warm cache |
|------|---------|------|------------|
| phparkitect | 1.3.0 | 7.5s | — *(no cache)* |
| deptrac | 4.7.2 | 10.7s | 2.7s |
| phpat | 0.11.10 | 35.4s | 2.7s |
